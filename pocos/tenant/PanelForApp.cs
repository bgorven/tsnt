...
namespace Tas.Tenant.PanelForApp
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.27.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class PanelForApp 
    {
        /// <summary>the app that produced this panel</summary>
        ...
        public static PanelForApp FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<PanelForApp>(data, new Newtonsoft.Json.JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });
        }
    }
}