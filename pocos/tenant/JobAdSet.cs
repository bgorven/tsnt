...
namespace Tas.Tenant.JobAdSet
{
    ...
    public partial class LinkedResource 
    {
        ...
        public static LinkedResource FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<LinkedResource>(data, new Newtonsoft.Json.JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });
        }
    }
    
    /// <summary>A schema for simple jobs, i.e. those that get uploaded in jobSets, typically to a public job board. Removes nuances such as status, internal candidates, etc.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.27.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class JobSetJob 
    {
        /// <summary>A short phrase describing the position as it would be listed on a business card or in a company directory</summary>
        ...
        /// <summary>A short (up to 75 characters) and enticing call to action for candidates for this job</summary>
        [Newtonsoft.Json.JsonProperty("shortSummary", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string ShortSummary { get; set; }
    
        /// <summary>The job's description. Job descriptions are formatted using the safe subset of markdown (see documentation for GET /jobs/{}/description)</summary>
        [Newtonsoft.Json.JsonProperty("description", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.Required]
        public string Description { get; set; }
    
        /// <summary>URI to view the opening - see HR-XML</summary>
        [Newtonsoft.Json.JsonProperty("viewUri", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string ViewUri { get; set; }
    
        /// <summary>URI of the page where a candidate applies - see HR-XML</summary>
        [Newtonsoft.Json.JsonProperty("applyUri", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// <summary>the date on which the job was advertised/posted - downstream job boards may use or ignore</summary>
        [Newtonsoft.Json.JsonProperty("datePosted", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTime? DatePosted { get; set; }
    
        [Newtonsoft.Json.JsonProperty("categories", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.ObjectModel.ObservableCollection<CategoryActual> Categories { get; set; }
    
        /// <summary>an array of links to resources (videos etc.) that are relevant to the job</summary>
        [Newtonsoft.Json.JsonProperty("links", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.ObjectModel.ObservableCollection<LinkedResource> Links { get; set; }
        ...
        public static JobSetJob FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<JobSetJob>(data, new Newtonsoft.Json.JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.27.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class JobAdSet 
    {
        /// <summary>true if this set is to be applied as a dry run - i.e. no changes should be made to the jobs at the target</summary>
        ...
        [System.ComponentModel.DataAnnotations.Required]
        public System.Collections.ObjectModel.ObservableCollection<JobSetJob> Jobs { get; set; } = new System.Collections.ObjectModel.ObservableCollection<JobSetJob>();
        ...
        public static JobAdSet FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<JobAdSet>(data, new Newtonsoft.Json.JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });
        }
    }
