...
namespace Tas.Tenant.CandidateEditSpec
{
    #pragma warning disable // Disable all warnings

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.27.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class CandidateMessage 
    {
        /// <summary>a text message to the candidate regarding their proposed edit, may include links</summary>
        [Newtonsoft.Json.JsonProperty("message", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.Required]
        public string Message { get; set; }
    
        [Newtonsoft.Json.JsonProperty("level", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public CandidateMessageLevel Level { get; set; }
        ...
        public static CandidateMessage FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<CandidateMessage>(data, new Newtonsoft.Json.JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.27.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class ResumeRule 
    {
        /// <summary>can a resume be uploaded at all, and can existing resume be seen</summary>
        ...
        /// <summary>is the resume mandatory - implies visible == true</summary>
        ...
        /// <summary>a message to help the candidate understand about uploading a resume - e.g. 'resume optional when a video is provided'</summary>
        ...
        [System.ComponentModel.DataAnnotations.Required]
        public System.Collections.ObjectModel.ObservableCollection<MediaType> Accept { get; set; } = new System.Collections.ObjectModel.ObservableCollection<MediaType>();
        ...
        public static ResumeRule FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<ResumeRule>(data, new Newtonsoft.Json.JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.27.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class VCardRule 
    {
        /// <summary>a simple way to hint that key vcard fields (first name, last name, email address) are mandatory - probably will get replaced by more fine-grained scheme in the future</summary>
        [Newtonsoft.Json.JsonProperty("someMandatory", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool SomeMandatory { get; set; }
    
        /// <summary>a simple way to hint that key vcard title field should be displayed</summary>
        [Newtonsoft.Json.JsonProperty("showPrefixField", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool ShowPrefixField { get; set; }
    
        /// <summary>the allowable titles from the ATS. E.g.: [ Mr., Mrs., Ms., Dr. ]</summary>
        [Newtonsoft.Json.JsonProperty("allowedPrefixes", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.ObjectModel.ObservableCollection<string> AllowedPrefixes { get; set; }
        ...
        public static VCardRule FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<VCardRule>(data, new Newtonsoft.Json.JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });
        }
    }
    
    /// <summary>rules specific to a single job application (i.e., not candidate-scoped)</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.27.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class ApplicationModel 
    {
        /// <summary>the job application these rules apply to</summary>
        ...
        [Newtonsoft.Json.JsonProperty("itemsRule", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.ObjectModel.ObservableCollection<ItemPackageRead> ItemsRule { get; set; }
        ...
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<ApplicationModel>(data, new Newtonsoft.Json.JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });
        }
    }
    ...
    {
        [Newtonsoft.Json.JsonProperty("requiredCategoryValues", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.ObjectModel.ObservableCollection<CategoryActual> RequiredCategoryValues { get; set; }
    
        [Newtonsoft.Json.JsonProperty("resumeRule", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.Required]
        public ResumeRule ResumeRule { get; set; } = new ResumeRule();
    
        [Newtonsoft.Json.JsonProperty("vCardRule", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.Required]
        public VCardRule VCardRule { get; set; } = new VCardRule();
        ...
        public static CandidateModel FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<CandidateModel>(data, new Newtonsoft.Json.JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.27.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class CandidateEditSpec 
    {
        /// <summary>just the same tracker that was passed in with the intent</summary>
        ...
        [Newtonsoft.Json.JsonProperty("candidateMessage", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public CandidateMessage CandidateMessage { get; set; }
    
        [Newtonsoft.Json.JsonProperty("candidateModel", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public CandidateModel CandidateModel { get; set; }
    
        [Newtonsoft.Json.JsonProperty("applicationModel", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        public static CandidateEditSpec FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<CandidateEditSpec>(data, new Newtonsoft.Json.JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.27.0 (Newtonsoft.Json v9.0.0.0)")]
    public enum CandidateMessageLevel
    {
