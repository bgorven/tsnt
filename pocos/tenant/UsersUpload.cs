...
namespace Tas.Tenant.UsersUpload
{
    ...
    public partial class UsersRead 
    {
        ...
        public System.Collections.ObjectModel.ObservableCollection<UserRead> Results { get; set; }
        ...
        public static UsersRead FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<UsersRead>(data, new Newtonsoft.Json.JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.27.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class UsersUpload 
    {
        /// <summary>true if this set is to be applied as a dry run - i.e. no changes should be made to the users at the target</summary>
        ...
        [System.ComponentModel.DataAnnotations.Required]
        public UsersRead Users { get; set; } = new UsersRead();
        ...
        public static UsersUpload FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<UsersUpload>(data, new Newtonsoft.Json.JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });
        }
    }
