...
namespace Tas.Tenant.CandidateEdit
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.27.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class CategoriesPatch 
    {
        [Newtonsoft.Json.JsonProperty("patchItems", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.Required]
        public System.Collections.ObjectModel.ObservableCollection<CategoryActual> PatchItems { get; set; } = new System.Collections.ObjectModel.ObservableCollection<CategoryActual>();
        ...
        public CategoriesPatchOp Op { get; set; }
        ...
        public static CategoriesPatch FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<CategoriesPatch>(data, new Newtonsoft.Json.JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });
        }
    }
    ...
    public partial class CandidateData 
    {
        ...
        public FileUpload Resume { get; set; }
    
        [Newtonsoft.Json.JsonProperty("jobNotifications", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool? JobNotifications { get; set; }
    
        [Newtonsoft.Json.JsonProperty("categoriesPatch", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public CategoriesPatch CategoriesPatch { get; set; }
        ...
        public static CandidateData FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<CandidateData>(data, new Newtonsoft.Json.JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });
        }
    }
    ...
    public partial class ApplicationData 
    {
        ...
        public static ApplicationData FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<ApplicationData>(data, new Newtonsoft.Json.JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.27.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class File2 : ItemWrite
    {
        [Newtonsoft.Json.JsonProperty("name", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.Required]
        public string Name { get; set; }
    ...
    public partial class CandidateEdit 
    {
        ...
        [Newtonsoft.Json.JsonProperty("candidateData", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        public static CandidateEdit FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<CandidateEdit>(data, new Newtonsoft.Json.JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });
        }
    }
