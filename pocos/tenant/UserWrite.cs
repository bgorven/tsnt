...
namespace Tas.Tenant.UserWrite
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.27.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class UserWrite 
    {
        [Newtonsoft.Json.JsonProperty("activeFlag", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool? ActiveFlag { get; set; }
    
        [Newtonsoft.Json.JsonProperty("orgs", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public CategoryActual Orgs { get; set; }
        ...
        public static UserWrite FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<UserWrite>(data, new Newtonsoft.Json.JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });
        }
    }
