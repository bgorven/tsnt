...
namespace Tas.Tenant.HomePage
{
    ...
    public partial class HomePage 
    {
        ...
        public static HomePage FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<HomePage>(data, new Newtonsoft.Json.JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });
        }
    }
}