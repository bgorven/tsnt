...
namespace Tas.Tenant.AssessmentWriteByApp
{
    ...
    /// <summary>package of data for an assessment app to update an assessment</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.27.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class AssessmentWriteByApp 
    {
        ...
        [Newtonsoft.Json.JsonProperty("interactionUris", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public InteractionUris InteractionUris { get; set; }
        ...
        public static AssessmentWriteByApp FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<AssessmentWriteByApp>(data, new Newtonsoft.Json.JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });
        }
    }
}