...
namespace Tas.Tenant.JobsUpload
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.27.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class JobsUpload 
    {
        ...
        [System.ComponentModel.DataAnnotations.Required]
        public JobsRead Jobs { get; set; } = new JobsRead();
        ...
        public static JobsUpload FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<JobsUpload>(data, new Newtonsoft.Json.JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });
        }
    }
