...
namespace Tas.Core.Route
{
    ...
    public partial class Route 
    {
        ...
        public ConsumingAppInstall ProducingAppInstall { get; set; }
        ...
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<Route>(data, new Newtonsoft.Json.JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });
        }
    }
