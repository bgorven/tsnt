...
namespace Tas.Core.RoutesConsumers
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.27.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class RoutesConsumers 
    {
        [Newtonsoft.Json.JsonProperty("consumingAppInstalls", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.ObjectModel.ObservableCollection<Anonymous> ConsumingAppInstalls { get; set; }
        ...
        [Newtonsoft.Json.JsonProperty("producingAppInstall", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public Anonymous ProducingAppInstall { get; set; }
        ...
        public static RoutesConsumers FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<RoutesConsumers>(data, new Newtonsoft.Json.JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });
        }
    }
